...
# 2. Load the dataset
dataset = pd.read_csv(r"E:\FSDS With GEN AI_NIT\5. May\5th,6th  - NLP project\5th,6th  - NLP project\4.CUSTOMERS REVIEW DATASET\Restaurant_Reviews.tsv", delimiter='\t', quoting=3)
